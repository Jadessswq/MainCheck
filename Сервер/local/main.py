...
Рекомендуемая модель (2026): qwen2.5:32b — лучшее качество русского
официально-делового стиля без thinking-режима, ответ за 5–30 с после прогрева.
Альтернативы: qwen2.5:14b (быстрее), gemma3:27b, mistral-small3.2:24b.
...
app = FastAPI(title="AI LibreOffice Suggester — Local", version="1.4.3")
