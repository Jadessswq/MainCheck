...
• цитируй короткий фрагмент вокруг ошибки (3–7 слов), а не весь длинный кусок;
• «стало» — такой же по длине фрагмент с применённой правкой;
...
app = FastAPI(title="AI LibreOffice Suggester — Local", version="1.5.9")
